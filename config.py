...
SPARK_MASTER = "spark://spark-master:7077"  # Hoặc "local[*]" cho local
...
SPARK_SERVER_IP = "192.168.1.100"  # IP máy Spark
KAFKA_SERVER_IP = "192.168.1.101"  # IP máy Kafka
AIRFLOW_SERVER_IP = "192.168.1.102"  # IP máy Airflow
